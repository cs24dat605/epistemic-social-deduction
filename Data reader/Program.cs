...
using (StreamReader sr = new StreamReader(filePath))
{
    ...
    for (int i = 0; i < parts.Length - (parts.Length%6); i += 6)
    {
        ...
        teamScores[parts[i + 1].Replace("Winning team: ", "").Replace("\"", "").Replace("\r", "")] += 1;
