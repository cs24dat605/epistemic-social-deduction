...
public class Consigliere : Role, IRoleNightAction
{
    ...
    public void PerformNightAction(Player player, ConcurrentBag<Action> actions)
    {
        ...
        foreach (World possibleWorld in player.PossibleWorlds.Where(possibleWorld => possibleWorld.IsPrivateActive))
        {
        ...
        foreach (World possibleWorld in player.PossibleWorlds.Where(possibleWorld => possibleWorld.IsPrivateActive && possibleWorld.Marks == Min))
        {
